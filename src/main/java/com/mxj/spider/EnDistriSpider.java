...
import com.mxj.commons.utils.DateUtil;
import com.mxj.dao.RedisConn;
import com.mxj.scheduler.RedisScheduler;
import com.mxj.scheduler.UrlFactory;
import com.mxj.utils.NetUtil;
 ...
 */
public class EnDistriSpider extends Spider {
	public EnDistriSpider(PageProcessor pageProcessor) {
		super(pageProcessor);
		JedisPool jedisPool = RedisConn.getJedisPool();
	...
	private void initUuid() {
		if (uuid == null && !distributed) {
			...
			try {
				this.uuid = this.pageProcessor.getClass().getSimpleName() + "_" + cronExp + "_" + NetUtil.getIpAddr();
